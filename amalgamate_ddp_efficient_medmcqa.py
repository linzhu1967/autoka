...
def new_single_ka_medmcqa_test(combination_name, knowledge_path_list, random_seed):
...
def new_ka_medmcqa_test(combination_name, knowledge_path_list, random_seed):
    # step-1: load the config file
